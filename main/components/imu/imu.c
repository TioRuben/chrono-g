...
esp_err_t imu_init_with_config(i2c_master_bus_handle_t bus_handle, 
    ...
    switch (config->accel_range) {
        case QMI8658_ACC_RANGE_2G:  current_config.accel_sensitivity = QMI8658_ACC_SENSITIVITY_2G; break;
        case QMI8658_ACC_RANGE_4G:  current_config.accel_sensitivity = QMI8658_ACC_SENSITIVITY_4G; break;
        case QMI8658_ACC_RANGE_8G:  current_config.accel_sensitivity = QMI8658_ACC_SENSITIVITY_8G; break;
        case QMI8658_ACC_RANGE_16G: current_config.accel_sensitivity = QMI8658_ACC_SENSITIVITY_16G; break;
        default: current_config.accel_sensitivity = QMI8658_ACC_SENSITIVITY_8G;
    }
    
    switch (config->gyro_range) {
        case QMI8658_GYR_RANGE_16_DPS:   current_config.gyro_sensitivity = QMI8658_GYR_SENSITIVITY_16DPS; break;
        case QMI8658_GYR_RANGE_32_DPS:   current_config.gyro_sensitivity = QMI8658_GYR_SENSITIVITY_32DPS; break;
        case QMI8658_GYR_RANGE_64_DPS:   current_config.gyro_sensitivity = QMI8658_GYR_SENSITIVITY_64DPS; break;
        case QMI8658_GYR_RANGE_128_DPS:  current_config.gyro_sensitivity = QMI8658_GYR_SENSITIVITY_128DPS; break;
        case QMI8658_GYR_RANGE_256_DPS:  current_config.gyro_sensitivity = QMI8658_GYR_SENSITIVITY_256DPS; break;
        case QMI8658_GYR_RANGE_512_DPS:  current_config.gyro_sensitivity = QMI8658_GYR_SENSITIVITY_512DPS; break;
        case QMI8658_GYR_RANGE_1024_DPS: current_config.gyro_sensitivity = QMI8658_GYR_SENSITIVITY_1024DPS; break;
        case QMI8658_GYR_RANGE_2048_DPS: current_config.gyro_sensitivity = QMI8658_GYR_SENSITIVITY_2048DPS; break;
        default: current_config.gyro_sensitivity = QMI8658_GYR_SENSITIVITY_1024DPS;
    }
...
esp_err_t imu_get_gyro_bias(float *bias_x, float *bias_y, float *bias_z) {
    ...
    if (bias_x) *bias_x = gyro_bias[0] / current_config.gyro_sensitivity;
    if (bias_y) *bias_y = gyro_bias[1] / current_config.gyro_sensitivity;
    if (bias_z) *bias_z = gyro_bias[2] / current_config.gyro_sensitivity;
